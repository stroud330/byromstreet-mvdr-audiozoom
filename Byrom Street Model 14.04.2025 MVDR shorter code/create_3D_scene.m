function [surfaces, world_objects] = create_3D_scene(dimensions)
...
patch('Parent', street_group,'XData', surfaces(11).position.x, 'YData', surfaces(11).position.y, 'ZData', surfaces(11).position.z, 'FaceColor', 'b');
