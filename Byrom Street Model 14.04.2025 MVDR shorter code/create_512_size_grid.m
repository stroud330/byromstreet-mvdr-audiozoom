function dimensions = create_512_size_grid(dimensions)
figure(1);
%% DRAW BLUE LINES (The lines are positioned based on the center of the mic array)

% Calculate the distances between grid lines based on desired lengths
distX = 4.572 / 3;  % Divide by 3 since the grid is 3x3
distY = 3.429 / 3;  % Divide by 3 since the grid is 3x3

dimensions.heightgrid = 4;
